...
id int, FirstName String, LastName String, Age int, BirthDate string
)
row format delimited fields terminated by ','
...
6.2. Alter table log_static_partition add partition(year=2016, month=06) location '/HadoopExam/logs/jun16';
Alter table log_static_partition add partition (year=2015, month=06) location '/HadoopExam/logs/jun15' ;
...
#sqoop import --connect jdbc:mysql://quickstart:3306/retail_db --username retail_dba --password cloudera \
--table categories \
--target-dir /HadoopExam/sqoopImport/category_subset4 \
--where 'category_id > 22' \
...
17.1 sqoop import --connect jdbc:mysql://quickstart:3306/retail_db --username retail_dba --password cloudera \
--table departments \
...
17.3 sqoop import --connect jdbc:mysql://quickstart:3306/retail_db --username retail_dba --password cloudera \
...
18. Hive, table must be created inside hive warehouse directory amd should not be an external:
